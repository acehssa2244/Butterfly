...
버터 플라이 (버터 플라이) 앱을 무료 앱으로 제작했습니다. 이 서비스는 무료로 제공되며 그대로 사용하도록되어 있습니다.
...
이 개인 정보 보호 정책에 사용 된 용어는 본 개인 정보 취급 방침에서 달리 정의되지 않는 한 Butterfly (버터 플라이)에서 액세스 할 수있는 이용 약관과 동일한 의미를 갖습니다.
